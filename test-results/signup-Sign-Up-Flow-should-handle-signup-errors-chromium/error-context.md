...
- text: Email address
- img
- textbox "Email address": test+1750990144029@example.com
- text: Password
- img
...
- region "Notifications (F8)":
  - list:
    - status:
      - text: Sign Up Failed User already registered
      - button:
        - img
- status: Notification Sign Up FailedUser already registered
```