    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:flex-1 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23000" fill-opacity="0.02"%3E%3Ccircle cx="7" cy="7" r="2"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-30" />
